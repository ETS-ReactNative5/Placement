...
var Student = localStorage.getItem("ApproveStudent")
...
//             console.log(res)
//         })
//         .then(()=>{history.push('/ApproveStudent')})
...
export default function EnhancedTable(props) {
    ...
    function Approve() {
        if (selectedList.length === 0) {
            ...
            axios.post("http://localhost:3010/ApproveStudent", selectedList)
                .then(alert("Approved"),
    ...
    return (
        ...
        <div className={classes.root}>
                                ...
                                {stableSort(rows, getComparator(order, orderBy))
                                    ...
                                    .map((row, index) => {
                                        ...
                                        return (
                                            <TableRow
                                                //   hover
                                                onClick={event => handleClick(event, row.RollNumber)}
                                                role="checkbox"
            ...
            <Button style={{ marginTop: 20, width: 100, background: '#424242', color: "white" }} onClick={Approve} type="submit">Approve</Button>
