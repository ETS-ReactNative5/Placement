...
const myObject = localStorage.getItem("CompanyDetail")
...
const headCells = [
    { id: 'Total', label: 'No. Of students', disablePadding: true, numeric: false },
...
export default function EnhancedTable() {
    ...
    return (
        ...
        <Grid container style={{ marginTop: 30 }}
            ...
            justify="center"
            alignItems="flex-end">
                {(rows.length===0)?<Typography>OOps No Student Placed in Selected year</Typography>
                :
